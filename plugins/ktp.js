...
`.trim()
  ...
  await m.reply('Sedang membuat...')
    ...
    let buff = ('https://api.lolhuman.xyz/api/ktpmaker?apikey=fwd201104&nik=' + nik + '&prov=' + prov + '&kabu=' + kabu + '&name=' + name + '&ttl=' + ttl + '&jk=' + jk + '&jl=' + jl + '&rtrw=' + rtrw + '&lurah=' + lurah + '&camat=' + camat + '&agama=' + agama + '&nikah=' + nikah + '&kerja=' + kerja + '&warga=' + warga + '&until=' + until + '&img=' + img);
