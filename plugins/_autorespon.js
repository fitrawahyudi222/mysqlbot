...
https://instagram.com/f.w.dalimunthe
`.trim(), '© fwd', 'PEMILIK BOT', ',owner', { contextInfo: { mentionedJid: [global.owner[0] + '@s.whatsapp.net'] } })
    }
    ...
    if (new Date() * 1 - setting.status > 1000) {
        ...
        await this.setStatus(`Aktif selama ${uptime} | Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Hanya Grup' : 'Publik'} | Mysql Bot oleh Fitra wahyudi`).catch(_ => _)
